...
# NOTE: Global CLI tools removed - they can be installed separately if needed
# Install individual tools with: npm install -g <package>@<version>
# Use pinned versions with checksums for security
